...
//}
//
//void PhysicsEngine::processCell(uint32_t index)
//{
//    const CollisionCell& c = grid.gridData[index];
//    for (uint32_t i{0}; i < c.objects_count; ++i) {
...
////    }
//
//    for (int row = 1; row < grid.width - 1; ++row) {
//        for (int col = 1; col < grid.height - 1; ++col) {
//            // Your code for each inner cell goes here
//            int index = row * grid.width + col;
//            solveCollisionThreaded(index);
//
//
//        }
//    }
